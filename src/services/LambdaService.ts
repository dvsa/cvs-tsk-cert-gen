...
import { InvokeCommandInput, InvokeCommandOutput, LambdaClient, InvokeCommand, } from "@aws-sdk/client-lambda";
...
class LambdaService {
  ...
  constructor(lambdaClient: LambdaClient) {
    ...
    this.lambdaClient = AWSXRay.captureAWSv3Client(new LambdaClient({
      ...config,
      ...lambdaClient
    }));
  }
